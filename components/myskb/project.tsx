  ...
  return (
    <LayoutWithoutSidebar shiftY="-translate-y-0">
      <FormWrapper onSubmit={handleSubmit}>
        ...
        <Spacing size="sm" />
        <FileUploadField id="statutoryDeclarationFile" name="statutoryDeclarationFile" title="Statutory Declaration" label="Statutory Declaration File" description="PDF up to 10MB" accept="pdf/*" requiredMessage="Please upload a cover photo statutory declaration" />
        <Spacing size="sm" />
        <FileUploadField id="landHeirDeclarationFile" name="landHeirDeclarationFile" title="Land Heir Declaration" label="Land Heir Declaration" description="PDF up to 10MB" accept="pdf/*" requiredMessage="Please upload a cover photo land heir declaration" />
        <Spacing size="sm" />
        <FileUploadField id="rentalAgreementFile" name="rentalAgreementFile" title="Rental Agreement" label="Rental Agreement" description="PDF up to 10MB" accept="pdf/*" requiredMessage="Please upload a cover photo rental agreement" />
        <LineSeparator />
