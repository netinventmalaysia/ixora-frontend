    ...
    <FormProvider {...methods}>
      <LayoutWithoutSidebar shiftY="-translate-y-0">
        ...
        <FormSectionHeader
          ...
          description={t(
            'myskb.home.sections.what.description',
        ...
        <FormSectionHeader
          ...
          description={t(
            'myskb.home.sections.objective.description',
            'To centralize and digitalize the management of building project registrations, approvals, and fee payments through a traceable platform—bridging consultants, project owners, and MBMB administrators.'
          )}
        />
