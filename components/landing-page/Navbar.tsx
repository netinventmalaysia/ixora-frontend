...
export default function Navbar() {
  ...
  <a href="/" className="flex items-center gap-2">
          {/* <Image src="/images/Banner.png" alt="IXORA MBMB" width={1024} height={90} className="h-7 w-auto" priority /> */}
  <span
    className="text-sm font-semibold tracking-wide 2xl:text-base transition-colors"
    style={{ color: PRIMARY }}
    onMouseOver={e => (e.currentTarget.style.color = PRIMARY_HOVER)}
